! function e(t, n, i) {
    ...
    4: [function() {
        ...
        var a = "404",
            ...
            d = "../box_bck.png",
            c = new function() {
                this.seedColor = [200, 0, 0], this.sideColor = [11, 10, 27], this.message = a, this.background = [30, 30, 30], this.pointColor = [153, 255, 255], this.ambientColor = [255, 153, 255], this.hsv = {}, this.explode = function() {
