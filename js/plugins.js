...
$(document).ready(function(){
	...
	/* googleMaps Footer Map */
		...
		var latlng = new google.maps.LatLng(33.96480,-117.83067); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
		var styles = [
			{
		...
		var options = {
		 ...
		 draggable:drag,
		 scrollwheel:false,
		 panControl : false, zoom : 10,
		 styles: styles
		};
		var wpgmappitymap = new google.maps.Map(document.getElementById('wpgmappitymap'), options);
		var point0 = new google.maps.LatLng(33.96480,-117.83067); <!-- (Fist Value Longitude, Second Value Latitude), can obtain YOUR coordenates here!: http://universimmedia.pagesperso-orange.fr/geo/loc.htm -->
